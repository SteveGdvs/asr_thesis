...
class EmbeddingSeq2Seq(Seq2Seq):
	...
	def __init__(self, rnn_type, rnn_size, embedding_size, num_encoder_tokens, num_decoder_tokens, target_token_to_index, target_index_to_token, max_decoder_seq_length, character_level):
	...
	def decode_sequence(self, input_seq):
		...
		target_seq = np.full((input_seq.shape[0], 1), start_token_index)
